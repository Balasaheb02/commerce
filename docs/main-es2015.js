...
const routes = [
    {
        path: 'home',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./main/home/home/home.module */ "./src/app/main/home/home/home.module.ts")).then(m => m.HomeModule),
    },
    // {
    //   path: 'details/:id',
    ...
    {
        path: 'finance',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./main/finance/finance.module */ "./src/app/main/finance/finance.module.ts")).then(m => m.FinanceModule),
    },
    {
        path: 'user',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./main/users/users.module */ "./src/app/main/users/users.module.ts")).then(m => m.UsersModule),
    },
    {
        path: 'company',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./main/companies/companies.module */ "./src/app/main/companies/companies.module.ts")).then(m => m.CompaniesModule),
    },
...
let CompaniesComponent = class CompaniesComponent {
    constructor(commerceService, loadingService) {
...
let UsersComponent = class UsersComponent {
    constructor(commerceService, router, loadingService) {
        this.commerceService = commerceService;
        this.router = router;
        this.loadingService = loadingService;
...
CommerceService.ctorParameters = () => [
